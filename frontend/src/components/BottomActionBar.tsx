...
export const BottomActionBar: React.FC<BottomActionBarProps> = ({
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 p-3 bg-slate-950/90 backdrop-blur-2xl border-t border-slate-800/90 flex items-center justify-center shadow-2xl safe-area-bottom">
        ...
        {!hasVideo ? (
          <>
            {!hasImage && (
              <button
                ...
                className="py-3 px-3.5 rounded-2xl bg-slate-800 hover:bg-slate-700 text-slate-200 font-bold text-xs flex items-center justify-center gap-1.5 border border-slate-700 active:scale-95 transition-all shadow-md"
              >
          ...
          <>
            <button
              ...
              className="py-3.5 px-3 rounded-2xl bg-slate-800/90 hover:bg-slate-800 text-slate-300 font-bold text-xs flex items-center justify-center gap-1 border border-slate-700 active:scale-95 transition-all shadow-md"
              title="Yeni Video"
            >
